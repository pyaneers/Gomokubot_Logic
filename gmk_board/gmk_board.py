# Board coordinate generator for modification:
# for i in range(0, 15):
#   for j in range(0, 15):
#     print(f'\'{i}#{j}\': 0,')
...
class Board():
    def __init__(self):
        ...
        self.match = []
        # remains False until the board is read with victory conditions, is then turned True and turned into other player.
        self.done = False
        # Each move made is appended to list as made.
        self.moves = []
        # 2D tuple grid dictionary
        self.board = {
            (0, 0): 0,
            (0, 1): 0,
            (0, 2): 0,
